Algoritmo ejercicio3
	// 3-	Declara un arreglo unidimensional llamado "numeros" con dimensió dinamica. Luego llenar el arreglo con números enteros ingresados por el usuario. Luego, calcular y muestrar la suma de todos los números pares en el arreglo.
